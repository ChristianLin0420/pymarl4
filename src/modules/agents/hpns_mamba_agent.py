...
class HPNS_MAMBAAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(HPNS_MAMBAAgent, self).__init__()
        self.args = args
        ...
        self.config = MambaConfig(d_model = args.mamba_hidden_dim, n_layers = args.mamba_layer)
    ...
    def forward(self, inputs, hidden_state):
        ...
        hh = self.model(x.unsqueeze(1)).squeeze(1)  # [bs * n_agents, rnn_hidden_dim]
